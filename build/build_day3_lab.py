...
{
 "app":"Assessment","sec":"MAP test","mins":"~10 min",
 "title":"D3.2 &middot; Post-program MAP test",
 "scenario":"Word for word the test you took on Tuesday morning, before we taught anything. We take it now, before the capstone, so it measures the teaching and not the afternoon. Eight minutes, silent, on your own.",
 "launches":[{"label":"Open the MAP test","href":"https://portal.joincoded.com/sv/ai-essentials-in-the-workplace-map-test-pre-day-1-09-00-copy","note":"Eight minutes, silent. Do not look anything up."}],
 "goal":"A submitted test that reflects what you know now, not what you can look up. There is no pass mark and your score is not shared.",
 "steps":["Open the link and start. Eight minutes.",
          "Answer from memory. Do not open Claude, the day pages or your notes.",
          "Submit, close the tab, and wait quietly for the room. The capstone starts at 10:40."],
 "findings":[{"label":"The question you were least sure about","hint":"that is your revision list for after today"}],
 "expect":"Test submitted before 10:40. Nothing else.",
 "stretch":"Go back to the day page for the topic you were least sure about. All three stay online after today.",
 "boss":"Write down the one question you were least sure about, then find the answer yourself rather than asking."
},
{
 "app":"In pairs","sec":"Capstone &middot; Phase 0","mins":"~10 min",
 "title":"D3.3 &middot; Phase 0. Pick your idea",
...
},
{
 ...
 "title":"D3.4 &middot; Deliverable 1. Executive briefing",
...
{
 "app":"Claude","sec":"Capstone &middot; D2","mins":"~25 min",
 "title":"D3.5 &middot; Deliverable 2. Charts that argue",
 "scenario":"Two or three charts that carry the argument, each with one written insight underneath. Not decoration. Evidence. They go into the deck after lunch, so build them first.",
...
{
 "app":"Claude Design or Gamma","sec":"Capstone &middot; D3","mins":"~20 min",
 "title":"D3.6 &middot; Deliverable 3. Stakeholder deck",
 "scenario":"Five or six slides that carry your briefing into a room, with the charts you built before lunch on slides 3 and 4. You compared the two tools yesterday. Now pick the one that fits this job and build it.",
 "launches":[{"label":"Open Claude","href":CLAUDE,"note":"Same conversation. It already has your analysis, your briefing and your charts."},
             {"label":"Open Gamma","href":GAMMA,"note":"If you preferred Gamma yesterday, build it here. Gamma cannot see your conversation, so paste the briefing text above the prompt and add the charts by hand."}],
 "goal":"A five or six slide deck that tells the same story as the briefing, carries your charts, and has every number checked by the person who did not build it.",
 "steps":["Choose your tool. One sentence on why, in the findings box. Gamma users: paste the briefing text first.",
          "Five or six slides: the decision, the situation, your two charts, the recommendation, the risk.",
 ...
 "promptSteps":[
  {"label":"The deck prompt",
   "goal":"The briefing turned into slides, with the charts in place, without the story drifting on the way.",
   "prompt":"Turn that briefing into a six slide stakeholder deck. Slide 1 the decision as a headline. Slide 2 the situation in three numbers. Slide 3 our first chart, with its claim as the caption. Slide 4 our second chart, the finding that complicates the obvious answer, with its claim as the caption. Slide 5 the recommendation and its cost. Slide 6 the risk and what we would do about it. Eight words or fewer per headline. Every figure carries its source.",
 ...
 "expect":"A five or six slide deck that tells the same story as the briefing, with your charts on it. If the deck and the briefing disagree anywhere, one of them is wrong and you need to know which.",
...
},
{
 ...
 "title":"D3.7 &middot; Deliverable 4. Communication pack",
...
{
 "app":"In the room","sec":"Present","mins":"~30 min",
 "title":"D3.8 &middot; Assemble, rehearse, present",
 "scenario":"Assemble the package, run the pitch once out loud, cut what does not earn its place. Three minutes per pair, then one question from the room.",
 "goal":"A three minute pitch you have actually run once, a package that tells one consistent story, and a ready answer for the obvious challenge.",
 ...
 "expect":"A three minute pitch you have run at least once, and a package where the briefing, the deck and the comms all say the same thing.",
 "stretch":"Prepare the ninety second emergency version. Schedules slip, and the pairs who can compress still land their recommendation.",
...
},
{
 ...
 "title":"D3.9 &middot; Survey, then certificates",
 "scenario":"Two things, in this order. The survey is how the next version of this programme gets better, so please be blunt. Then a certificate and a photograph.",
 "launches":[{"label":"Open the survey","href":"https://portal.joincoded.com/sv/ai-essentials-in-the-workplace-end-of-programme-survey","note":"Five minutes. Please be blunt."}],
 "goal":"Survey submitted before 13:55, with one honest sentence in it that would be uncomfortable to say out loud.",
 "steps":["<b>13:50</b> End of program survey. Five minutes, and please be blunt.",
          "<b>13:55</b> Certificates and a photograph."],
 "findings":[{"label":"One thing you would change about this programme","hint":"put this in the survey too"},
             {"label":"The one thing you will do differently on Sunday","hint":"one task, one change"}],
 "expect":"Survey submitted. Then a certificate and a photograph.",
 "stretch":"Download your capstone package before the photograph, not after. People leave straight after the photograph.",
 "boss":"Write the message you will send your manager on Sunday morning, in three lines, saying what you built and what you want to try first."
},
]
